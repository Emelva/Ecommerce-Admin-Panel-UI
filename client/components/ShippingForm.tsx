...
export default function ShippingForm({setShippingForm}: {setShippingForm:(data: ShippingFormInput) => void}){
    ...
    return(
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleShippingForm)}>
            <div className="flex flex-col gap-1">
                ...
                type="text" id="name" placeholder="Jane doe" {...register("name")}/>
                {errors.name && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="email" id="email" placeholder="Janedoe@gmail.com" {...register("email")}/>
                {errors.email && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="text" id="phone" placeholder="1234567890" {...register("phone")}/>
                {errors.phone && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="text" id="address" placeholder="42 off crescent st. Yourtown" {...register("address")}/>
                {errors.address && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="text" id="city" placeholder="Lagos" {...register("city")}/>
                {errors.city && (
                    <p className="text-xs text-red-500">{errors.city.message}</p>
                )}
            </div>
            <button className="w-full bg-gray-800 text-white p-2 rounded-lg cursor-pointer 
