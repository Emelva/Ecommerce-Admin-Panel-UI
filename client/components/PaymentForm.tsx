    ...
    return(
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handlePaymentForm)}>
            <div className="flex flex-col gap-1">
                <label htmlFor="cardHolde" className="text-xs text-gray-500 font-medium">Name on Card</label>
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="text" id="cardHolder" placeholder="Jane doe" {...register("cardHolder")}/>
                {errors.cardHolder && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                type="text" id="cardNumber" placeholder="1234567890" {...register("cardNumber")}/>
                {errors.cardNumber && (
            ...
            <div className="flex items-center gap-2 mt-4">
                <Image src={'/klarna.png'} alt="klarma" width={50} height={25}/>
